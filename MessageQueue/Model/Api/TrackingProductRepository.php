...
use MagentoAssessment\MessageQueue\Api\DataInterfaceFactory; // Corrected namespace
use MagentoAssessment\MessageQueue\Api\TrackingProductInterface; // Corrected interface name

class TrackingProductRepository implements TrackingProductInterface // Corrected interface name
{
    /**
     * @var DataInterfaceFactory
     */
    private $dataInterfaceFactory; // Corrected property name
    ...
    public function __construct(
        ...
        DataInterfaceFactory $dataInterfaceFactory, // Corrected property name
        TrackingProductModel $model,
        TrackingProductResource $resource
    ) {
        $this->collectionFactory = $collectionFactory;
        $this->dataInterfaceFactory = $dataInterfaceFactory; // Corrected property name
        $this->model = $model;
